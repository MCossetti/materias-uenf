...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 03b-variaveis) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; novas duas expressoes do tipo let:
;#i significa 'inexato'
(display "O resultado = ")
(let (  (t sqrt)
        (v expt)
